...
public final class DialogChangePasswordBinding implements ViewBinding {
  ...
  private DialogChangePasswordBinding(@NonNull LinearLayout rootView,
      @NonNull TextInputEditText currentPassword, @NonNull TextInputEditText newPassword) {
  ...
  public static DialogChangePasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextInputEditText currentPassword = ViewBindings.findChildViewById(rootView, id);
      ...
      return new DialogChangePasswordBinding((LinearLayout) rootView, currentPassword, newPassword);
    }
