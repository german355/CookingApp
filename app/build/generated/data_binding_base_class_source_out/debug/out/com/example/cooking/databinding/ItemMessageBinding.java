...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull FrameLayout rootView, @NonNull TextView textViewMessage) {
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageBinding((FrameLayout) rootView, textViewMessage);
    }
