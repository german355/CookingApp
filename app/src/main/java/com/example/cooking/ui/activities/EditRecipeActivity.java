...
public class EditRecipeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Валидация прав на редактирование с помощью UserPermissionUseCase
        UserPermissionUseCase.PermissionResult permissionResult = userPermissionUseCase.canEditRecipe(recipeToEdit.getUserId());
        if (!permissionResult.hasPermission()) {
            ...
            Log.d(TAG, "Информация о правах: " + userPermissionUseCase.getUserPermissionInfo());
            finish();
            return;
        }
        Log.d(TAG, "Права проверены успешно: " + userPermissionUseCase.getUserPermissionInfo());
    ...
    private void setupRecyclerViews() {
        ingredientsAdapter = new IngredientAdapter(
            new IngredientAdapter.IngredientUpdateListener() {
                @Override
        ...
        stepsAdapter = new StepAdapter(this, 
            new StepAdapter.StepUpdateListener() {
                @Override
